...
The latest release is always available on the `releases/latest` branch.
Note that doing a `git pull` on this branch can be disruptive when we
make a major release, as package recipes will be updated.
